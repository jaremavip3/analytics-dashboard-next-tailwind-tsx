    ...
    <div className="flex flex-col gap-6">
      <div className="grid w-full mx-auto grid-cols-1 sm:grid-cols-2 gap-6">
        <Card className="w-full">
          ...
          <p className="text-3xl text-dark-tremor-content-inverted font-semibold">
            {avgVisitorsPerDay}
          </p>
        </Card>
        <Card className="w-full">
      ...
      <Card className="flex flex-col sm:grid grid-cols-4 gap-6">
        <h2 className="w-full text-dark-tremor-content-inverted text-center sm:left-left font-semibold text-xl">
        ...
        <div className="col-span-3 flex items-center justify-between flex-wrap gap-8">
          {topCountries?.map(([countryCode, number]) => {
            return (
              <div
                key={countryCode}
                className="flex items-center gap-3 text-dark-tremor-content-inverted">
                ...
                <p className="text-tremor-content sm:text-dark-tremor-content-inverted">{number}</p>
              </div>
            );
          })}
        </div>
